...
## [2026-06-20 13:43] Ingest | 创建标准页面和技术指标页面（图谱链接）

- 为 24 份标准创建独立 Wiki 页面（wiki/standards/）
- 为 54 个技术指标创建独立页面（wiki/indicators/）
- 标准页面通过 [[链接]] 引用技术指标页面
- 技术指标页面反向链接到引用它的标准
- 标准页面通过 [[链接]] 引用概念页（所属领域）
- 更新 wiki/index.md 目录
- 更新 VAULT-INDEX.md
- 在 Obsidian 图谱视图中可看到标准→指标→值的链接关系

## [2026-06-20 13:47] Ingest | 按类别组织标准页面

- 删除 24 个单独标准页面和 54 个指标页面（太细化）
- 改为按类别创建 4 个标准技术指标页面：
  - wiki/standards/肥料类标准技术指标（12 份标准）
  - wiki/standards/燃气与能源类标准技术指标（6 份标准）
  - wiki/standards/水泥类标准技术指标（2 份标准）
  - wiki/standards/化工原料类标准技术指标（4 份标准）
- 每个类别页面通过 [[链接]] 关联到对应的概念页
- 更新 wiki/index.md、VAULT-INDEX.md
